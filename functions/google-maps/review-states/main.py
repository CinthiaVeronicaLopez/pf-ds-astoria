...
# Leer el archivo json del bucket de GCS
...
def batch_process(project_id, dataset_id, table_id, blob):
    '''
...
def main_gcs(cloud_event: CloudEvent) -> tuple:
    ...
    # leer el archivo json linea por linea y ejecutar la función normalize
    print(f"Procesando...")
    batch_process(project_id, dataset_id, table_id, blob)
